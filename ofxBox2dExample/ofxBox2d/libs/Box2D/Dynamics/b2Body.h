...
inline void b2Body::ApplyForce(const b2Vec2& force, const b2Vec2& point, bool wake = true)
{
...
inline void b2Body::ApplyLinearImpulse(const b2Vec2& impulse, const b2Vec2& point, bool wake = true)
{
    if (m_type != b2_dynamicBody)
    {
        return;
